"""
Создает MySQL базу данных и пользователя test с паролем 12345 для доступа к ней
Аргументы командной строки:
--root_dir : главная папка проекта
--data_loc : папка с данными
--user, --passwd : логин и пароль для подключения к MySQL Server
